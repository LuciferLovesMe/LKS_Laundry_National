...
{
    public partial class PrepaidPackage : Form
    {
        ...
        void loadpackage()
        {
            string com = "select package.id, service.name from package join service on package.idService = service.id";
        ...
        void getprice()
        {
            command = new SqlCommand("select * from package where id = " + comboBox1.SelectedValue, connection);
